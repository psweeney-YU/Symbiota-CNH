<?php 
//
// THIS CONFIG SHOULD ONLY BE USED IN CI DO NOT USE IT IN ANY PRODUCTION ENV
// 
...
$MEDIA_ROOT_URL = 'ci_temp/';			//URL path to images
$MEDIA_ROOT_PATH = $SERVER_ROOT . '/' . $MEDIA_ROOT_URL;			//Writable path to images, especially needed for downloading images

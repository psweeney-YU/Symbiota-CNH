...
<head>
  ...
  <style>
    ...
    #build-label li .material-icons {
      font-size: 12px;
      padding-left: 6px
    }

    #build-label>li span.material-icons:hover {
    ...
    #instructions {
      width: 100%;
      background-color: rgba(255, 255, 255, .637);
      position: absolute;
      top: 0
    }
    ...
    .field-block>span.material-icons.disabled {
      background: #d3d3d3;
      color: gray;
      cursor: not-allowed
    }

    .field-block>span.material-icons.disabled:hover {
      background: #d3d3d3
    }
  ...
  <?php if ($customStyle): ?>
    <style>
      <?= htmlspecialchars($customStyle, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>
    </style>
  <?php endif; ?>
</head>
